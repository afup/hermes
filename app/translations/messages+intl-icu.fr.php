...
return [
    ...
    'discord' => [
        ...
        'join_transport' => [
            ...
            'validation_driver' => 'Un nouveau passager a rejoins votre transport {direction} (à {hour} le {date}), il va probablement vous contacter mais vous pouvez aussi lui envoyer un DM: <@{traveler_id}>',
            'error' => [
                'no_transport' => '⛔ Vous n\'avez aucun transport(s) crée pour l\'évènement de ce canal.',
